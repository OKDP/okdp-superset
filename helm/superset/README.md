...
![Version: 6.0.0-1.0](https://img.shields.io/badge/Version-6.0.0--1.0-informational?style=flat-square)

Apache Superset is a modern, enterprise-ready business intelligence web application

This chart is a wrapper (or a meta chart) above the original official [superset chart](https://github.com/apache/superset/tree/superset-helm-chart-6.0.0/helm/superset) and references it as a subchart dependency to provide overrides and enrichment for the existing default values.
...
```console
$ helm install my-release oci://quay.io/okdp/charts/superset --version 6.0.0-1.0
```
...
2. `superset` section: contains the orignal [superset chart](https://github.com/apache/superset/tree/superset-helm-chart-6.0.0/helm/superset) values.
   These values can be customized as well. You can also check the values directly in the reference [superset chart](https://github.com/apache/superset/tree/superset-helm-chart-6.0.0/helm/superset).
